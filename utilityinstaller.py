...
def setUpTunnels():
	...
	executeCMDShell("sudo sh -c \"echo gispremote:xxx | chpasswd\"")
...
def installSnort():
	...
	executeCMDShell("mysql -u root --password=violet -e 'create database snort;use snort; '")
	executeCMDShell("mysql -u root --password=violet -e 'use snort; source ~/barnyard2/schemas/create_mysql;'")
	executeCMDShell("mysql -u root --password=violet -e \"use snort; CREATE USER 'snort'@'localhost' IDENTIFIED BY 'violet';\"")
	executeCMDShell("mysql -u root --password=violet -e \"use snort; grant create, insert, select, delete, update on snort.* to 'snort'@'localhost';\"")
	print "Snort installation now complete"

#ip address is 104.155.93.54
# office pivot 10.83.0.85
...
def installNewOpenVas():
	...
	### look for User created with password '32ff5e20-5917-43c4-b11e-f09ac9b46969'.
...
# infosec server 	23.251.143.38
# cloud SQL 		104.155.90.128	3306
